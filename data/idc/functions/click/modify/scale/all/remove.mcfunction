#> idc:click/modify/scale/all/remove
#   # scaleの設定 remove
# @within function idc:click/modify/scale/all/

# スコアを1減算
    scoreboard players remove @s idc.scale.x 1
    scoreboard players remove @s idc.scale.y 1
